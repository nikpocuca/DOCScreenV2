...
public var MemoryTask: ORKOrderedTask{
    ...
    let trial1QuestionStep = ORKQuestionStep(identifier: "trial1TextChoiceQuestionStep", title: trial1QuestionStepTitle, answer: trial1AnswerFormat)
    ...
    let trial2QuestionStep = ORKQuestionStep(identifier: "trial2TextChoiceQuestionStep", title: trial2QuestionStepTitle, answer: trial2AnswerFormat)
    
    steps += [trial2QuestionStep]
    
    
    return ORKOrderedTask(identifier: "MemoryTask", steps: steps)
}
